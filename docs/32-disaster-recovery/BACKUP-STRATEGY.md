...
*E.g., An admin accidentally deletes a critical blog post and the 30-day soft delete window has passed.*
...
*E.g., A Prisma migration goes wrong and corrupts multiple tables.*
...
*E.g., The primary AWS region hosting the Supabase instance goes offline.*
