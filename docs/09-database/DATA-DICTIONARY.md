...
| *embedding* | *vector(1536)* | *Raw SQL (pgvector)* | *Actual vector stored via raw migration* | Ã¢â‚¬â€ | IVFFlat | `[0.001, -0.02, ...]` |
...
*Generated from `apps/api/prisma/schema.prisma` Ã¢â‚¬â€ 34 models (tables) across 8 domains + 1 enum.*
