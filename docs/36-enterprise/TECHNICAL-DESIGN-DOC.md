...
All TDDs should be tracked in the decision log (`docs/23-governance/DecisionLog.md`) with their status.

---

_This template is adapted from Google's Engineering Design Doc format and Stripe's RFC process._
