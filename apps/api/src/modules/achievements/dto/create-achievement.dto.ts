...
export class CreateAchievementDto {
  ...
  @ApiPropertyOptional({ example: 'Amazon Web Services' }) @IsOptional() @IsString() @MaxLength(200)
  issuer?: string;
  ...
  @ApiPropertyOptional({ example: 'certification' }) @IsOptional() @IsString() @MaxLength(100)
  category?: string;
