...
```json
{
  ...
  "properties": {
    ...
    "metadata": {
      ...
      "examples": [
        { "department": "engineering", "priority": "high", "source": "github-webhook" }
      ]
    },
    "agent_id": {
      "type": "string",
...
*This document is maintained by the Enterprise Architecture team. Propose changes via the architecture RFC process.*
