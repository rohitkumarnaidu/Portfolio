...
> **Note:** This document covers QA processes. For detailed testing architecture, see [TESTING-ARCHITECTURE.md](./TESTING-ARCHITECTURE.md).
...
| ----------------------------------------------------- | ------------------------------------------------------------------------------------ |
| `docs/21-operations/25-CICD.md` (v5.0)                | CI/CD pipeline Ã¢â‚¬â€ quality gates in CI workflow, automated test execution        |
| `docs/35-quality/PerformanceArchitecture.md` (v5.0)   | Performance testing strategy, budgets, Lighthouse CI integration                     |
| `docs/35-quality/AccessibilityArchitecture.md` (v5.0) | Accessibility testing strategy, WCAG 2.2 AA compliance verification                  |
| `docs/35-quality/TestingArchitecture.md` (v5.0)       | Testing architecture Ã¢â‚¬â€ unit, integration, E2E, visual, security, AI test types |
| `docs/21-operations/DevOpsArchitecture.md` (v5.1)     | DevOps Ã¢â‚¬â€ test infrastructure, environment management, build optimization       |
| `docs/21-operations/DeploymentGuide.md` (v5.0)        | Deployment Ã¢â‚¬â€ staging environment, rollback procedures, deploy window policy    |
| `docs/11-security/SecurityArchitecture.md` (v5.0)     | Security testing Ã¢â‚¬â€ OWASP compliance, DAST scanning, penetration testing        |
| `docs/05-architecture/SystemArchitecture.md` (v5.0)   | System architecture Ã¢â‚¬â€ QA environment topology, service boundaries              |
...
_Document Version: 5.0 Ã¢â‚¬â€ Enterprise-Grade QA Framework_  
