...
|-----------|-------------|
| docs/api/12-API.md | API error response format and status codes |
| docs/api/44-API-STANDARDS.md | API standards for error handling |
| docs/operations/22-OBSERVABILITY.md | Error monitoring and alerting |
