...
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/04-design/DesignSystem.md` (v5.0)             | UI/UX architecture — WCAG compliance matrix, ARIA patterns, focus management                                                                                                       |
| `docs/04-design/DesignSystem.md` (v5.0)             | Design system — accessible component specs, focus trap, skip link, reduced motion                                                                                                  |
| `docs/04-design/DesignTokens.md` (v5.0)             | Visual design — color system, contrast philosophy, animation design                                                                                                                |
| `docs/05-architecture/SystemArchitecture.md` (v5.0) | Architecture — component architecture for accessibility                                                                                                                            |
| `docs/05-architecture/10-TECHSTACK.md` (v5.0)       | Tech stack — testing tools, Radix UI, shadcn/ui                                                                                                                                    |
| `docs/35-quality/PerformanceArchitecture.md` (v5.0) | Performance — animation performance, CLS prevention                                                                                                                                |
| `docs/35-quality/TestingArchitecture.md` (v3.0)     | Testing strategy — accessibility test requirements                                                                                                                                 |
| `docs/35-quality/30-QA.md` (v3.0)                   | QA — manual accessibility test protocols                                                                                                                                           |
