...
This design system is the single source of truth for all visual components and design tokens across the portfolio platform. It implements the visual identity defined in `docs/design/DesignTokens.md` as concrete, reusable React components and CSS custom properties. Every component targets WCAG 2.2 AA compliance, supports light and dark themes, and follows the 4px/8px spacing system.
