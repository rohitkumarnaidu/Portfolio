...
> **Related:** [System Architecture](../architecture/SystemArchitecture.md) | [Testing Architecture](../quality/TestingArchitecture.md) | [Security Architecture](../security/SecurityArchitecture.md) | [CI/CD Pipeline](../operations/53-CI-CD-PIPELINE.md) | [Deployment Guide](../operations/DeploymentGuide.md) | [Incident Response](../operations/incident-response-playbook.md)
...
Postmortems follow the template at [`docs/operations/post-incident-review-template.md`](../operations/post-incident-review-template.md) and must include:
...
- Feature flags (see [`docs/operations/60-FEATURE-FLAGS.md`](../operations/60-FEATURE-FLAGS.md)) enable merging incomplete work safely — never use long-lived branches to hide unfinished features.
...
- See [`docs/security/SecurityArchitecture.md`](../security/SecurityArchitecture.md) and [`docs/security/SecretsManagement.md`](../security/SecretsManagement.md) for detailed requirements.
...
The CI/CD pipeline is defined in `.github/workflows/ci.yml` and documented in [`docs/operations/25-CICD.md`](../operations/25-CICD.md) and [`docs/operations/53-CI-CD-PIPELINE.md`](../operations/53-CI-CD-PIPELINE.md).
...
5. **File a postmortem** — if the incident affected users, follow the post-incident review template at [`docs/operations/post-incident-review-template.md`](../operations/post-incident-review-template.md)

For a comprehensive rollback runbook, see the [Incident Response Playbook](../operations/incident-response-playbook.md).
...
All feature flags follow the lifecycle in [`docs/operations/60-FEATURE-FLAGS.md`](../operations/60-FEATURE-FLAGS.md). Every flag must have a cleanup date. Flags without a scheduled cleanup are considered technical debt (see Section 9).
...
For the full release readiness checklist, see [`docs/operations/ReleaseChecklist.md`](../operations/ReleaseChecklist.md).
...
3. **Diagnosis** — Follow scenario-specific runbooks (500 errors, slow responses, auth failures, etc.) in the [Incident Response Playbook](../operations/incident-response-playbook.md)
...
The postmortem template is at [`docs/operations/post-incident-review-template.md`](../operations/post-incident-review-template.md). It must include:
...
All known technical debt is tracked in [`docs/operations/TechnicalDebtRegister.md`](../operations/TechnicalDebtRegister.md). Each entry includes:
...
| What | Where | Required? |
|------|-------|-----------|
| Architecture decisions | `docs/adr/` or inline in architecture docs | Required for all significant decisions |
| API endpoints | Swagger decorators in code, plus `docs/api/` reference | Required for all endpoints |
...
| Security controls | `docs/security/` per control type | Required for all auth/authz/data protection |
| Operation runbooks | `docs/operations/` | Required for CI/CD, deploy, incident response |
| Testing patterns | `docs/quality/` | Required for new test categories |
...
```markdown
See [Secrets Management](../security/SecretsManagement.md) for secret rotation policies.
Refer to [CI/CD Pipeline](../operations/53-CI-CD-PIPELINE.md) for deployment workflow details.
```
...
The security architecture is documented in [`docs/security/SecurityArchitecture.md`](../security/SecurityArchitecture.md) and covers 10 domains across 40+ security controls.

### 11.2 Secrets Management

Secrets must never be hardcoded. The policy is defined in [`docs/security/SecretsManagement.md`](../security/SecretsManagement.md):
...
Data is classified into four tiers per the [Data Classification Policy](../security/data-classification.md):
...
| CI/CD Pipeline | [`docs/operations/25-CICD.md`](../operations/25-CICD.md) |
| CI/CD Pipeline (Detailed) | [`docs/operations/53-CI-CD-PIPELINE.md`](../operations/53-CI-CD-PIPELINE.md) |
| Deployment Guide | [`docs/operations/DeploymentGuide.md`](../operations/DeploymentGuide.md) |
| Incident Response Playbook | [`docs/operations/incident-response-playbook.md`](../operations/incident-response-playbook.md) |
| Post-Incident Review Template | [`docs/operations/post-incident-review-template.md`](../operations/post-incident-review-template.md) |
| Release Checklist | [`docs/operations/ReleaseChecklist.md`](../operations/ReleaseChecklist.md) |
| Release Management | [`docs/operations/ReleaseManagement.md`](../operations/ReleaseManagement.md) |
| Feature Flags | [`docs/operations/60-FEATURE-FLAGS.md`](../operations/60-FEATURE-FLAGS.md) |
| Technical Debt Register | [`docs/operations/TechnicalDebtRegister.md`](../operations/TechnicalDebtRegister.md) |
| Secrets Management | [`docs/security/SecretsManagement.md`](../security/SecretsManagement.md) |
| Data Classification | [`docs/security/data-classification.md`](../security/data-classification.md) |
| Error Budget Policy | [`docs/engineering/error-budget-policy.md`](error-budget-policy.md) |
| Debugging Guide | [`docs/engineering/debugging-guide.md`](debugging-guide.md) |
