...
import type { CreateCaseStudyDto, UpdateCaseStudyDto } from '../../modules/case-studies/dto';
...
export class AdminCaseStudiesController {
  ...
  @Post()
  @Roles('admin', 'editor')
  @Audit({ action: 'create', resource: 'case_study' })
  ...
  @Patch(':id')
  @Roles('admin', 'editor')
  @Audit({ action: 'update', resource: 'case_study' })
  ...
  @Delete(':id')
  @Roles('admin')
  @Audit({ action: 'delete', resource: 'case_study' })
