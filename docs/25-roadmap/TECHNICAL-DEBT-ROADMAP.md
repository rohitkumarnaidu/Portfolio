...
**Dependencies:** Must be resolved before the Sandbox IDE can ship to production. Documented in docs/37-future/Sandbox-AI-IDE.md.
...
4. Document in docs/35-quality/TestingArchitecture.md
...
4. Track in docs/24-development/RFC-002-tanstack-query.md as a follow-up RFC
...
- **33-onboarding:** docs/33-onboarding/developer-onboarding.md exists but covers only developer setup; no operations/admin onboarding
...
4. Document the targeting rule format in docs/21-operations/60-FEATURE-FLAGS.md
...
3. Document the decision in docs/05-architecture/AnimationArchitecture.md
...
4. Update docs/09-database/DataRetention.md with the retention schedule
...
4. Document E2E test patterns in docs/35-quality/E2EStrategy.md
...
| docs/37-future/Sandbox-AI-IDE.md                  | Feature spec affected by TEC-002, TEC-004                                                                                         |
| docs/35-quality/TestingArchitecture.md            | Testing strategy affected by TEC-006, TEC-019                                                                                     |
| docs/05-architecture/AnimationArchitecture.md     | Animation framework decisions affected by TEC-014                                                                                 |
| docs/24-development/RFC-002-tanstack-query.md     | RFC affected by TEC-007 validation unification                                                                                    |
| docs/09-database/DataRetention.md                 | Data retention policy affected by TEC-015                                                                                         |
| docs/21-operations/60-FEATURE-FLAGS.md            | Feature flag documentation affected by TEC-011                                                                                    |
| docs/10-api/ErrorHandling.md                      | Error handling pattern affected by TEC-013                                                                                        |
...
_Document Version: 1.0 -- Technical Debt Roadmap_
