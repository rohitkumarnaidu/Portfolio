...
| **No agent marketplace**                        | Cannot discover or install third-party agents       | Design spec only Ã¢â‚¬â€ see `docs/design-spec/AGENT-MARKETPLACE.md` |
...
| `docs/08-ai/README.md`                                  | AI docs index with implementation status    |

### Design Specs (not implemented Ã¢â‚¬â€ use for reference only)

| Document                                | What It Describes                                    |
| --------------------------------------- | ---------------------------------------------------- |
| `docs/08-ai/18-AGENTS.md`               | Multi-agent framework (not implemented)              |
| `docs/08-ai/AGENT-MARKETPLACE.md`       | Agent marketplace (not implemented)                  |
| `docs/08-ai/AGENT-REGISTRY.md`          | Agent registration and discovery (not implemented)   |
| `docs/08-ai/MEMORY-ARCHITECTURE.md`     | Long-term memory system (not implemented)            |
| `docs/08-ai/COMMAND-SYSTEM.md`          | AI command parsing (not implemented)                 |
| `docs/08-ai/AUTOMATION-ARCHITECTURE.md` | Automated workflows (not implemented)                |
| `docs/08-ai/AGENT-CAPABILITIES.md`      | Agent capability framework (not implemented)         |
| `docs/08-ai/SKILLS.md`                  | AI skill system (not implemented)                    |
| `docs/08-ai/CONTEXT-ARCHITECTURE.md`    | Context window management (not implemented)          |
| `docs/08-ai/KNOWLEDGE-ARCHITECTURE.md`  | Knowledge graph architecture (not implemented)       |
| `docs/08-ai/AI-ARCHITECTURE.md`         | Overall AI architecture vision (mostly aspirational) |

### Model Cards

| Document                                     | What It Covers                 |
| -------------------------------------------- | ------------------------------ |
| `docs/08-ai/model-cards/GPT4O.md`            | GPT-4o model details           |
| `docs/08-ai/model-cards/CLAUDE-SONNET.md`    | Claude Sonnet model details    |
| `docs/08-ai/model-cards/TEXT-EMBEDDING-3.md` | text-embedding-3 model details |
