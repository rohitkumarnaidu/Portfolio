...
| **Knowledge Management**             | Runbooks stored in repo `/docs/30-runbooks/`, lessons learned captured in PIR  | Section 9                                          |
...
_Document Version: 1.0 — Enterprise Edition — ITIL 4 & ISO 20000 Compliant_
