...
3. **🔴 C-03: Cross-reference collision** — `docs/01-product/ContentArchitecture.md` doesn't exist; `docs/08-ai/17-AI_INSTRUCTIONS.md` existed historically and is now canonically §17
...
| **C-03** | Cross-reference collision: `docs/01-product/ContentArchitecture.md` referenced in MASTER INDEX and AUDIT REPORT but actual file is `17-AI_INSTRUCTIONS.md` | 🔴 Critical | `00-MASTER-INDEX.md`, `DOC-AUDIT-REPORT.md`, Constitution §17 references                                                                        | DOC-003  |
...
| **H-06** | MASTER INDEX references non-existent `docs/01-product/ContentArchitecture.md` path | `00-MASTER-INDEX.md`                                              | DOC-002  |
...
| **H-11** | Ceremony documents not referenced in MASTER INDEX                                  | `docs/23-governance/AGENDA.md`, `docs/23-governance/MATERIALS.md` | DOC-002  |
...
| **M-12** | Ceremony materials lack document metadata headers                             | `docs/23-governance/AGENDA.md`, `docs/23-governance/MATERIALS.md`      | DOC-001  |
...
| _33_   | _`33-ROADMAP.md` (Legacy)_             |       ✅       |       ✅        |       ❌       |        ⚠️         |       🔵        |      —      | **60%**  |
| _34_   | _`34-IMPLEMENTATION_PLAN.md` (Legacy)_ |       ✅       |       ✅        |       ❌       |        ✅         |       ✅        |      —      | **73%**  |
| _35_   | _`35-FOLDER_STRUCTURE.md` (Legacy)_    |       ✅       |       ✅        |       ❌       |        ❌         |       🔵        |      —      | **53%**  |
| _33_   | _`RATIFICATION.md` (No symlink)_       |       ✅       |       ✅        |       ✅       |        ✅         |       ✅        |      —      | **100%** |
| _34_   | _`CHEATSHEET.md` (No symlink)_         |       ✅       |       ✅        |       ✅       |        ✅         |       🔵        |      —      | **100%** |
| _35_   | _`AUDIT-REPORT.md` (No symlink)_       |       ✅       |       ✅        |       ⚠️       |        ✅         |       ✅        |      —      | **87%**  |
| _Cer_  | `docs/23-governance/AGENDA.md`         |       ❌       |       ❌        |       ✅       |        ✅         |       ✅        |      —      | **60%**  |
| _Cer_  | `docs/23-governance/MATERIALS.md`      |       ❌       |       ❌        |       ✅       |        ✅         |       🔵        |      —      | **60%**  |

> **Note:** Documents marked _Legacy_ (33-35 old) have been superseded by the new governance documents (RATIFICATION, CHEATSHEET, AUDIT-REPORT) and the renumbered execution documents (36-38).
...
The **per-doc compliance matrix** checks the canonical file only (`docs/23-governance/33-RATIFICATION.md`). The unnumbered copies have been consolidated and removed.
...
`docs/23-governance/AGENDA.md` — No standard header
`docs/23-governance/MATERIALS.md` — No standard header
...
| -------------------------- | ------------------------------------------- | ------------------------- | ----------------------------------------------------------------- |
| `00-MASTER-INDEX.md`       | `docs/01-product/ContentArchitecture.md`    | §17 Documentation         | ❌ File doesn't exist; should be `17-AI_INSTRUCTIONS.md`          |
| `32-SKILL.md` (§17 TOC)    | `docs/01-product/ContentArchitecture.md`    | Documentation Standards   | ❌ File doesn't exist; should be `17-AI_INSTRUCTIONS.md`          |
| `32-SKILL.md` (References) | `docs/08-ai/17-AI_INSTRUCTIONS.md` (v5.0)   | AI operating model        | ⚠️ Correct path, but §17 is now AI_INSTRUCTIONS not DOCUMENTATION |
| `00-MASTER-INDEX.md`       | `docs/23-governance/33-RATIFICATION.md`     | Ratification doc          | ❌ Symlink not created                                            |
| `00-MASTER-INDEX.md`       | `docs/23-governance/34-CHEATSHEET.md`       | Cheatsheet doc            | ❌ Symlink not created                                            |
| `00-MASTER-INDEX.md`       | `docs/23-governance/35-AUDIT-REPORT.md`     | Audit Report              | ❌ Symlink not created                                            |
| `00-MASTER-INDEX.md`       | `docs/01-product/ProductRoadmap.md`         | Roadmap (bumped)          | ❌ Symlink not created                                            |
| `00-MASTER-INDEX.md`       | `docs/01-product/37-IMPLEMENTATION_PLAN.md` | Impl Plan (bumped)        | ❌ Symlink not created                                            |
...
`DesignSystem.md`, `SystemArchitecture.md`, `17-AI_INSTRUCTIONS.md`, `32-SKILL.md` (Constitution), `34-IMPLEMENTATION_PLAN.md` (v5.0), `RATIFICATION.md`, `CHEATSHEET.md`, `AUDIT-REPORT.md`, `docs/23-governance/AGENDA.md`, `docs/23-governance/MATERIALS.md`, `00-MASTER-INDEX.md`
...
| ----------------------------- | ---------------- | ------------------------------------------------------------------------------- |
| All 39 docs indexed?          | ⚠️ 36/39 indexed | Missing: `docs/23-governance/AGENDA.md`, `docs/23-governance/MATERIALS.md`      |
...
| File path accuracy?           | ⚠️ 1 incorrect   | `docs/01-product/ContentArchitecture.md` referenced but doesn't exist           |
...
| ------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `docs/23-governance/33-RATIFICATION.md`     | Canonical (unnumbered RATIFICATION.md removed — consolidated)                                 |
| `docs/23-governance/34-CHEATSHEET.md`       | Canonical (unnumbered CHEATSHEET.md removed — consolidated)                                   |
| `docs/23-governance/35-AUDIT-REPORT.md`     | Canonical (unnumbered AUDIT-REPORT.md removed — consolidated)                                 |
| `docs/01-product/ProductRoadmap.md`         | `docs/01-product/ProductRoadmap.md` (Legacy, superseded)                                      |
| `docs/01-product/37-IMPLEMENTATION_PLAN.md` | `docs/01-product/37-IMPLEMENTATION_PLAN.md` (Legacy, superseded — OR upgrade to current v5.0) |
...
| **P1-3** | H-11: Ceremony docs not indexed   | Add `docs/23-governance/AGENDA.md` and `docs/23-governance/MATERIALS.md` to MASTER INDEX | Chief Architect | 15 min |
...
| `docs/23-governance/AGENDA.md`            | Medium         | 100+  | Governance | Ceremony      |
| `docs/23-governance/MATERIALS.md`         | Medium         | 100+  | Governance | Ceremony      |
...
| --------------------------------------- | ----------------------------------------------- |
| `docs/23-governance/32-SKILL.md §17`    | Documentation Standards — audit criteria source |
| `docs/MASTER-INDEX.md`                  | Document inventory — cross-reference source     |
| `docs/23-governance/35-AUDIT-REPORT.md` | Codebase compliance audit — companion report    |
| `docs/23-governance/33-RATIFICATION.md` | Governance framework — ceremony process         |
