...
> **Supersedes:** `docs/11-security/SecretsManagement.md` (v1.0)
...
See `docs/11-security/secrets-rotation-schedule.md` for the full schedule. This section summarizes per-secret procedure.
