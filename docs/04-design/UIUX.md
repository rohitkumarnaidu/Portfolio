...
- **Other Docs:** `docs/04-design/DesignTokens.md` (Scroll Animation Specifications)
...
| ----------------------------------------------------- | ---------------------------------------------------------- |
| `docs/01-product/ProductRequirements.md` (v3.0)       | Product requirements Ã¢â‚¬â€ UX requirements traceability  |
| `docs/01-product/02-FEATURES.md` (v3.0)               | Feature catalog Ã¢â‚¬â€ all F-XXX IDs referenced           |
| `docs/01-product/03-USER-STORIES.md` (v3.0)           | User stories Ã¢â‚¬â€ US-XXX IDs referenced                 |
| `docs/04-design/UserFlows.md` (v5.0)                  | Screen specifications Ã¢â‚¬â€ all screen states referenced |
| `docs/04-design/DesignTokens.md` (v5.0)               | Visual design Ã¢â‚¬â€ micro-interactions, color system     |
| `docs/04-design/DesignSystem.md` (v5.0)               | Component specifications Ã¢â‚¬â€ design tokens             |
| `docs/35-quality/PerformanceArchitecture.md` (v5.0)   | Performance budgets Ã¢â‚¬â€ animation performance targets  |
| `docs/35-quality/AccessibilityArchitecture.md` (v3.0) | Full WCAG implementation details                           |
| `docs/35-quality/TestingArchitecture.md` (v3.0)       | Testing strategy Ã¢â‚¬â€ a11y and UX test coverage         |
