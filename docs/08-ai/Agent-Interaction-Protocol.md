...
> **Related:** [PROMPT-LIBRARY.md](./PROMPT-LIBRARY.md) | [AGENT-NETWORKING.md](./AGENT-NETWORKING.md) | [AGENT.md](./AGENT.md) | [18-AGENTS.md](./18-AGENTS.md)
...
| -------------------------------------------- | ------------------------------------------------ |
| [PROMPT-LIBRARY.md](./PROMPT-LIBRARY.md)     | Prompt templates and agent instruction patterns  |
