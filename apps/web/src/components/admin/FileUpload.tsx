...
export function FileUpload({
  ...
  return (
    <div className="space-y-4">
      <div
        ...
        className={cn(
          ...
          dragOver
            ...
            : 'border-border-primary hover:border-border-accent hover:bg-surface-elevated/50',
        )}
      >
        <input
          ref={inputRef}
        ...
        <div className="space-y-3 bg-surface-secondary rounded-xl p-4 border border-border-primary">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={uploading}
              className="flex-1 px-4 py-2 rounded-xl bg-accent-500 text-white text-sm font-medium hover:bg-accent-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {uploading ? (
            ...
            <button
              ...
              disabled={uploading}
              className="px-4 py-2 rounded-xl bg-surface-elevated text-text-secondary text-sm font-medium hover:text-text-primary transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
          </div>
      ...
      {error && (
        <p className="text-sm text-semantic-error bg-semantic-error-bg rounded-lg px-3 py-2">
          {error}
        </p>
      )}
    </div>
