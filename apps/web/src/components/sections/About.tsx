...
export function About({ data }: { data?: Section }) {
  ...
  const bio =
    content.bio ||
    "I'm a full-stack developer with over 8 years of experience building enterprise-grade web applications. I specialize in React, Next.js, NestJS, and TypeScript, and I'm passionate about creating fast, accessible, and beautiful digital experiences.";
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto mb-16 text-center">
        <p className="text-body-lg text-text-secondary text-pretty">{bio}</p>
      </div>
