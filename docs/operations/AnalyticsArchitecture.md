...
|--------|------|---------------|--------------|
| **Analytics Service (API)** | `apps/api/src/modules/analytics/analytics.service.ts` | Lead events, system events, batch aggregation | lead_*, auth_*, content_* |
...
| **AI Analytics (AI)** | `apps/ai/app/services/analytics_service.py` | AI-specific events, cost tracking | chat_*, rag_*, agent_* |
...
*Not publicly accessible — admin-only. Visitors have no access to analytics.*
...
|-------|----------|--------|-------------|-------------|
| **Phase 1: Foundation** | 1 week | page_*, section_*, project_*, nav_*, web_vital_*, scroll_depth | Umami + PostHog SDK installed | Core traffic + engagement tracking |
| **Phase 2: Conversion** | 1 week | contact_form_*, lead_*, resume_*, cta_*, social_* | Phase 1 + API AnalyticsModule | Lead capture + conversion tracking |
| **Phase 3: AI & Agent** | 2 weeks | chat_*, agent_*, rag_*, cost_*, model_fallback | Phase 2 + AI service | AI performance + cost tracking |
| **Phase 4: Deep Analytics** | 1 week | skill_*, testimonial_*, experience_*, blog_*, case_study_*, filter_* | Phase 2 + all frontend components | Full portfolio interaction tracking |
| **Phase 5: SEO & Performance** | 1 week | seo_*, organic_*, lighthouse_*, build_*, uptime_* | Phase 1 + GSC + Sentry | SEO + perf monitoring |
...
*Document Version: 4.0 — Enterprise-Grade Analytics Strategy*  
