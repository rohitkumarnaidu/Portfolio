...
- **Emergency Rotation:** If a secret is suspected to be compromised (e.g., leaked on GitHub), it must be rotated _immediately_ following the Incident Response playbooks.
