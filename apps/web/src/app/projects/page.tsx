      ...
      {isLoading ? (
        <div className="card-grid">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="rounded-2xl bg-surface-secondary border border-border-primary p-6 space-y-4 animate-pulse"
            >
              ...
              <Card variant="interactive" padding="md" className="flex flex-col h-full">
                <div className="aspect-video bg-surface-elevated rounded-lg mb-4 flex items-center justify-center relative overflow-hidden">
                  {project.cover_image ? (
                    ...
                    <span className="text-4xl font-display text-text-tertiary/30">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <h3 className="text-h4 font-display text-text-primary mb-2 group-hover:text-accent-500 transition-colors">
                    {project.title}
                  </h3>
                  {project.description && (
