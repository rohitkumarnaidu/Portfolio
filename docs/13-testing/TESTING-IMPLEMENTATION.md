...
export const TEST_SEED = {
  ...
  projects: [
    { id: 'proj-001', slug: 'public-project', title: 'Public Project', is_private: false, is_featured: true },
    { id: 'proj-002', slug: 'private-project', title: 'Private Project', is_private: true, is_featured: false },
  ],
  leads: [
    { id: 'lead-001', name: 'Test User', email: 'test@example.com', message: 'Test message', status: 'new' },
  ],
};
```
...
*Testing Implementation Plan for Portfolio Platform*
