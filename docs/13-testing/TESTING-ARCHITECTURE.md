...
| ----------------------------------------------------- | --------------------------------------------------------------------------- |
| `docs/21-operations/25-CICD.md` (v5.0)                | CI/CD pipeline — testing stages in CI workflow, quality gates               |
| `docs/35-quality/PerformanceArchitecture.md` (v5.0)   | Performance testing strategy, Lighthouse CI, k6 load testing                |
| `docs/35-quality/AccessibilityArchitecture.md` (v5.0) | Accessibility testing strategy, axe-core integration, manual audit protocol |
| `docs/35-quality/30-QA.md` (v3.0)                     | QA process — manual testing, acceptance criteria, QA review gates           |
| `docs/11-security/SecurityArchitecture.md` (v5.0)     | Security testing — OWASP compliance, DAST scanning, penetration testing     |
| `docs/05-architecture/SystemArchitecture.md` (v5.0)   | System architecture — test architecture, service boundaries, data flow      |
| `docs/10-api/12-API.md` (v5.0)                        | API documentation — endpoint specs for API test generation                  |
| `docs/21-operations/DevOpsArchitecture.md` (v5.1)     | DevOps — test infrastructure, build performance, test optimization          |
| `docs/21-operations/DeploymentGuide.md` (v5.0)        | Deployment — test in staging before promote to production                   |
...
| ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `docs/21-operations/25-CICD.md` (v5.0)                | CI/CD Pipeline — testing stages, quality gates, parallelization strategy                                  |
| `docs/35-quality/PerformanceArchitecture.md` (v5.0)   | Performance Architecture — Lighthouse CI, k6 load testing, bundle analysis, performance budgets           |
| `docs/35-quality/AccessibilityArchitecture.md` (v5.0) | Accessibility Architecture — WCAG 2.2 AA compliance matrix, screen reader testing, focus management tests |
| `docs/35-quality/30-QA.md` (v3.0)                     | QA Process — manual testing, acceptance criteria, QA review gates, release sign-off                       |
| `docs/11-security/SecurityArchitecture.md` (v5.0)     | Security Architecture — OWASP ASVS compliance, penetration testing, DAST scanning                         |
| `docs/05-architecture/SystemArchitecture.md` (v5.0)   | System Architecture — test architecture, service boundaries, data flow for integration tests              |
| `docs/10-api/12-API.md` (v5.0)                        | API Documentation — endpoint specs for API test generation, response schemas                              |
| `docs/09-database/DatabaseArchitecture.md` (v5.0)     | Database Schema — schema for DB test assertions, RLS policies for security tests                          |
| `docs/21-operations/DevOpsArchitecture.md` (v5.1)     | DevOps — test infrastructure, Turborepo cache optimization, build performance                             |
| `docs/21-operations/DeploymentGuide.md` (v5.0)        | Deployment — staging environment for pre-deploy tests, smoke test targets                                 |
...
- [TESTING-STRATEGY.md](./TESTING-STRATEGY.md) — Superseded testing strategy (historical reference)
