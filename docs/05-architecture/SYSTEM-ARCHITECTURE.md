...
- **Screens:** `docs/04-design/UserFlows.md` (Full screen specifications)
- **Components:** `docs/04-design/DesignSystem.md` (Component implementations)
...
- **API Docs:** `docs/10-api/12-API.md` (Full endpoint documentation)
...
- **Full Schema:** `docs/09-database/DatabaseArchitecture.md` (Complete schema with RLS policies)
...
- **CMS Features:** `docs/01-product/02-FEATURES.md` (F-600, F-601, F-602, F-603)
- **Admin Screens:** `docs/04-design/UserFlows.md` (SCREEN-016)
...
- **Events:** `docs/21-operations/AnalyticsArchitecture.md` (Complete event catalog)
- **Dashboard:** `docs/04-design/UserFlows.md` (SCREEN-014)
...
- **AI Features:** `docs/01-product/02-FEATURES.md` (F-300, F-301, F-302, F-303, F-304, F-305)
- **RAG Specs:** `docs/08-ai/19-RAG.md` (Full RAG pipeline documentation)
...
- **Auth Features:** `docs/01-product/02-FEATURES.md` (F-700, F-701, F-702)
- **Auth Screens:** `docs/04-design/UserFlows.md` (SCREEN-012: Admin Login)
...
- **CI/CD:** `docs/21-operations/25-CICD.md` (Full pipeline configuration)
- **Deployment:** `docs/21-operations/DeploymentGuide.md` (Step-by-step deployment guide)
...
- **Monitoring:** `docs/21-operations/MonitoringArchitecture.md` (Full monitoring configuration)
- **Observability:** `docs/21-operations/22-OBSERVABILITY.md` (v5.0 Ã¢â‚¬â€ Enterprise observability covering logging, metrics, tracing, monitoring, alerting, incident management, SLOs, SLIs, runbooks, escalation, RCA, recovery, and enterprise standards)
...
const securityHeaders = [
  ...
  { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
  {
    ...
    value:
      "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; img-src 'self' data: blob: https:;",
  },
];
```
...
- **Full Security:** `docs/11-security/SecurityArchitecture.md` (Complete OWASP implementation)
- **Authorization:** `docs/11-security/15-AUTHORIZATION.md` (Role and permission details)
...
| ------------------------------------------------- | ------------------------------------------------------------------- |
| `docs/01-product/ProductRequirements.md` (v3.0)   | Product Requirements Ã¢â‚¬â€ architecture requirements traceability |
| `docs/01-product/02-FEATURES.md` (v3.0)           | Feature catalog Ã¢â‚¬â€ F-XXX IDs referenced throughout             |
| `docs/04-design/UserFlows.md` (v5.0)              | Screen specifications Ã¢â‚¬â€ pages built on this architecture      |
| `docs/04-design/DesignSystem.md` (v5.0)           | Design system Ã¢â‚¬â€ components implemented on this architecture   |
| `docs/05-architecture/10-TECHSTACK.md` (v5.0)     | Technology decisions Ã¢â‚¬â€ rationale for each tech choice         |
| `docs/09-database/DatabaseArchitecture.md` (v5.0) | Database schema Ã¢â‚¬â€ full DDL and RLS policies                   |
| `docs/10-api/12-API.md` (v5.0)                    | API documentation Ã¢â‚¬â€ all endpoint specs                        |
| `docs/05-architecture/13-INTEGRATIONS.md` (v5.0)  | Third-party integrations Ã¢â‚¬â€ setup and config                   |
| `docs/11-security/SecurityArchitecture.md` (v5.0) | Security implementation Ã¢â‚¬â€ OWASP compliance                    |
| `docs/21-operations/DeploymentGuide.md` (v5.0)    | Deployment Ã¢â‚¬â€ environment-specific configuration               |
| `docs/21-operations/25-CICD.md` (v5.0)            | CI/CD pipeline Ã¢â‚¬â€ workflow definitions                         |
