...
> **Document:** `docs/23-governance/AGENDA.md` | **Version:** 1.1 | **Last Updated:** June 2026  
...
| ☐   | Print signature sheets from `docs/23-governance/MATERIALS.md` | Jun 23 (Tue) | 10 min    |
...
| ----------------------------------------- | -------------- | ------------------------------------ |
| Signature sheets (Engineering Leadership) | 1              | `docs/23-governance/MATERIALS.md §2` |
| Signature sheets (Engineering Team)       | 1              | `docs/23-governance/MATERIALS.md §3` |
| Signature sheets (Witnesses)              | 1              | `docs/23-governance/MATERIALS.md §4` |
| Reservation log                           | 1              | `docs/23-governance/MATERIALS.md §5` |
| Oath cards                                | 1 per attendee | `docs/23-governance/MATERIALS.md §6` |
| Voting scorecards                         | 1 per attendee | `docs/23-governance/MATERIALS.md §7` |
...
> **Note:** This is an _abbreviated_ ceremonial reading. The full text is pre-read by attendees. Sections are grouped into reader blocks. Focus on the section's purpose and the rules that matter most.
...
> **Note:** This is an _abbreviated_ ceremonial reading. Attendees have pre-read their sections. The goal is acknowledgment, not teaching.
...
**Reservation Form:** (from `docs/23-governance/MATERIALS.md §5`)
...
> **THE ENGINEER'S OATH**
>
> _I commit to uphold the AI Engineering Constitution in every line of code I write,_
> _every pull request I review, and every deployment I make._
>
> _I will prioritize quality over speed, clarity over cleverness,_
> _and accessibility over exclusion._
>
> _I will hold myself and my teammates to these standards,_
> _not as a burden, but as a demonstration of our craft._
>
> _This I affirm, freely and without reservation._
...
| --- | ----------------------------------------------------------------- | ------------------- | ---------------- |
| ☐   | Fill placeholder names in `docs/23-governance/33-RATIFICATION.md` | Chief Architect     | +14 days (Jul 8) |
...
(docs/23-governance/32-SKILL.md) as the supreme governing document for
...
1. Read the Executive Summary (docs/23-governance/32-SKILL.md §1)
...
| ---------------------------------------------- | ----------------------------------------------------------------- |
| `docs/23-governance/33-RATIFICATION.md` (v1.0) | Ratification process and governance framework                     |
| `docs/23-governance/32-SKILL.md` (v5.0)        | The AI Engineering Constitution being ratified                    |
| `docs/23-governance/MATERIALS.md`              | Printable ceremony materials (signature sheets, oath cards, etc.) |
