...
export function useProjects(category?: string) {
  return useSWR(['projects', category], () => getProjects({ category }), { ...defaultConfig });
}
```
...
| MSW                   | API mocking        | Handlers per feature in **tests**/mocks |
...
_End of Frontend Architecture v1.1 - 20 sections, 15+ diagrams, enterprise reference_
