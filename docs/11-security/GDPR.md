...
| **Data Classification Policy** | `docs/11-security/data-classification.md`  | Classifies data by sensitivity (L1–L4)            |
| **Security Architecture**      | `docs/11-security/SecurityArchitecture.md` | Technical and organizational security measures    |
...
| **Data Governance Policy**     | `docs/11-security/43-DATA-GOVERNANCE.md`   | Governance framework, roles, and responsibilities |
...
| Audit logging for admin mutations          | ✅     | `docs/11-security/AuditLogging.md`                 |
