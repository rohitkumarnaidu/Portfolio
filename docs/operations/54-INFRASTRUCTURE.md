...
*Rationale: Serverless functions time out too quickly for complex LLM orchestrations. A lightweight container provides WebSocket/SSE support.*
...
*If traffic exceeds free tiers, the upgrade path involves moving Vercel to Pro ($20/mo) and Supabase to Pro ($25/mo), enabling massive scale.*
