...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'h2': [
          'clamp(1.75rem, 3vw + 0.75rem, 2.25rem)',
          { lineHeight: '1.2', fontWeight: '600' },
        ],
        'h3': [
          'clamp(1.375rem, 2vw + 0.5rem, 1.75rem)',
        ...
        'body-lg': [
          'clamp(1rem, 1vw + 0.5rem, 1.125rem)',
          { lineHeight: '1.6' },
        ],
        'body': [
          'clamp(0.938rem, 1vw + 0.5rem, 1rem)',
          { lineHeight: '1.6' },
        ],
        'body-sm': [
          'clamp(0.813rem, 0.5vw + 0.5rem, 0.875rem)',
          { lineHeight: '1.5' },
        ],
        'caption': [
          '0.75rem',
  ...
  plugins: [
    ...
    plugin(({ addUtilities }) => {
      addUtilities({
        '.bg-dots': {
          backgroundImage: 'radial-gradient(circle, var(--dot-color, var(--border-primary)) var(--dot-size, 1px), transparent var(--dot-size, 1px))',
