...
This document is a **specialized extension** of the AI Operating Model defined in `docs/ai/17-AI_INSTRUCTIONS.md` v4.0. The RAG pipeline directly implements the following sections:
...
|-----------|-------------|
| `docs/ai/17-AI_INSTRUCTIONS.md` (v5.0) | AI Operating Model — master AI governance document; RAG is a specialized extension of §6, §10, §11, §15 |
| `docs/database/DatabaseArchitecture.md` (v5.0) | Database schema — §11 AI & RAG Tables (document_chunks, embeddings_cache), §15.1 IVFFlat Index |
| `docs/api/12-API.md` (v5.0) | API documentation — §20 AI API Endpoints (Chat SSE, Analyze, Suggest) |
| `docs/architecture/SystemArchitecture.md` (v5.0) | System architecture — §7 AI Architecture, RAG Pipeline diagram, Model Routing |
| `docs/architecture/10-TECHSTACK.md` (v5.0) | Technology stack — §4 AI Microservice (FastAPI, LangChain, pgvector) |
| `docs/architecture/13-INTEGRATIONS.md` (v5.0) | Integrations — §8 OpenAI, pgvector setup |
| `docs/security/SecurityArchitecture.md` (v5.0) | Security — §12 AI Security, RLS policies for RAG tables |
| `docs/operations/AnalyticsArchitecture.md` (v5.0) | Analytics — RAG-specific events, cost tracking |
| `docs/operations/21-MONITORING.md` (v3.0) | Monitoring — RAG quality alerts, health checks |
| `docs/ai/18-AGENTS.md` (v3.0) | Agents documentation — project-wide AI development guide |
...
*Document Version: 4.0 — Enterprise-Grade RAG Pipeline*  
