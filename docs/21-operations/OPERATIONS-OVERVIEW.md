...
| -------------------- | ----------------------------------------------------- | ----------------- | ------------------ |
| Incident Response    | `docs/30-runbooks/IncidentResponse.md`                | Any P0/P1 alert   | Acknowledge < 5min |
| Incident Management  | `docs/30-runbooks/IncidentManagement.md`              | Incident declared | Update < 15min     |
| Post-Incident Review | `docs/21-operations/post-incident-review-template.md` | Incident resolved | 48h to complete    |

### 1.2 Service Recovery

| Runbook           | Location                                 | Description                         |
| ----------------- | ---------------------------------------- | ----------------------------------- |
| Service Restart   | `docs/30-runbooks/service-restart.md`    | Restart API, AI, or worker services |
| Database Failover | `docs/30-runbooks/database-failover.md`  | Promote replica, verify consistency |
| SSL Renewal       | `docs/30-runbooks/ssl-renewal.md`        | Certificate rotation and validation |
| Rollback Playbook | `docs/31-playbooks/rollback-playbook.md` | Safe deployment rollback procedure  |

### 1.3 Maintenance and Backup

| Runbook            | Location                                | Cadence             |
| ------------------ | --------------------------------------- | ------------------- |
| Maintenance Guide  | `docs/30-runbooks/MaintenanceGuide.md`  | Per change window   |
| Backup Recovery    | `docs/30-runbooks/BackupRecovery.md`    | Weekly verification |
| Migration Strategy | `docs/30-runbooks/MigrationStrategy.md` | Per schema change   |
