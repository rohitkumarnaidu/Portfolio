  ...
  if (error || !caseStudy || !project) {
    return (
      <div className="pt-32 pb-24 section-container text-center">
        ...
        <Link href="/case-studies" className="text-accent-500 hover:text-accent-600">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4" role="list">
              {csMetrics.map(([key, value]) => (
                <div
                  key={key}
                  className="p-6 rounded-xl bg-surface-secondary border border-border-primary text-center"
                  role="listitem"
                >
          ...
          <section>
            ...
            <div className="space-y-6" role="list" aria-label="Architecture diagrams">
              {caseStudy.architectureDiagrams.map((url, i) => (
                <div
                  key={i}
                  className="rounded-xl bg-surface-secondary border border-border-primary p-4"
                  role="listitem"
                >
                  <img
                    src={url}
          ...
          <section>
            ...
            <div className="space-y-4" role="list" aria-label="Code snippets">
              {caseStudy.codeSnippets.map((url, i) => (
                <div
                  key={i}
                  className="rounded-xl bg-surface-elevated border border-border-primary p-4 overflow-x-auto"
                  role="listitem"
                >
                  <img
                    src={url}
