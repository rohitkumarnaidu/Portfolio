...
```json
{
  ...
  "regulatory_notifications": [{ "authority": "DPA", "notified_at": "2026-07-18T10:00:00Z" }]
}
```
...
| ---------------------------------------------- | -------- | --------------------------------------------------------------- |
| `docs/11-security/SecurityArchitecture.md`     | All      | Security implementation details (OWASP, rate limiting, headers) |
| `docs/11-security/15-AUTHORIZATION.md`         | All      | Auth flows, JWT implementation, RBAC                            |
| `docs/35-quality/AccessibilityArchitecture.md` | All      | WCAG 2.2 AA implementation, 35-component a11y matrix            |
| `docs/05-architecture/10-TECHSTACK.md`         | §13      | Third-party integrations (PostHog, Sentry, Supabase)            |
| `docs/21-operations/AnalyticsArchitecture.md`  | §7       | Privacy, cookie consent, GDPR compliance for analytics          |
| `docs/05-architecture/13-INTEGRATIONS.md`      | §2.2     | Third-party processor DPAs                                      |
| `docs/23-governance/32-SKILL.md`               | §11, §12 | Security and Accessibility standards                            |
| `docs/23-governance/35-AUDIT-REPORT.md`        | §2       | Codebase audit — compliance findings                            |
...
| `docs/11-security/SecurityArchitecture.md` (v5.0)     | Security implementation — OWASP, headers, rate limiting |
| `docs/11-security/15-AUTHORIZATION.md` (v5.0)         | Auth flows and authorization                            |
| `docs/35-quality/AccessibilityArchitecture.md` (v5.0) | WCAG 2.2 AA implementation                              |
| `docs/23-governance/32-SKILL.md` (v5.0)               | AI Engineering Constitution — supreme governing law     |
