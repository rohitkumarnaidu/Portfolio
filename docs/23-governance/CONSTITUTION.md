...
| **Format**           | `ADR-NNN.md` in `docs/27-decisions/` directory. See `docs/05-architecture/SystemArchitecture.md §14` for template |
...
const securityHeaders = [
  ...
  { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
  {
    ...
    value:
      "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; img-src 'self' data: blob: https:; style-src 'self' 'unsafe-inline'; font-src 'self' data:; connect-src 'self' https://*.supabase.co https://api.openai.com https://api.anthropic.com https://app.posthog.com;",
  },
];
```
...
| DSG-004 | **Typography must use `font-display` (Cabinet Grotesk) for headings and `font-body` (Inter) for body text.** | Type scale defined in `docs/04-design/DesignSystem.md §1.2`              |
...
| DSG-008 | **All interactive elements must have hover, focus, and active states.**                                      | Micro-interaction catalog in `docs/04-design/DesignSystem.md §5.1`       |
...
| ---------------------- | ------------------------------------------------------------- | ------------ | -------------------------------------- |
| Primary call to action | `<Button variant="primary">`                                  | primary      | `docs/04-design/DesignSystem.md §2.1`  |
| Secondary action       | `<Button variant="secondary">`                                | secondary    | `docs/04-design/DesignSystem.md §2.1`  |
| Destructive action     | `<Button variant="danger">`                                   | danger       | `docs/04-design/DesignSystem.md §2.1`  |
| Content grouping       | `<Card variant="default">`                                    | default      | `docs/04-design/DesignSystem.md §2.2`  |
| Interactive content    | `<Card variant="interactive">`                                | interactive  | `docs/04-design/DesignSystem.md §2.2`  |
| Status/tag             | `<Badge variant="default">`                                   | default      | `docs/04-design/DesignSystem.md §2.4`  |
| Status indicator       | `<Badge variant="success" \| "warning" \| "error" \| "info">` | semantic     | `docs/04-design/DesignSystem.md §2.4`  |
| Form input             | `<Input.Field>` + `<Input.Label>` + `<Input.Error>`           | composed     | `docs/04-design/DesignSystem.md §2.3`  |
| Dialog/confirm         | `<Modal size="sm" \| "md" \| "lg">`                           | per use case | `docs/04-design/DesignSystem.md §2.5`  |
| Notification           | `<Toast variant="success" \| "error">`                        | per variant  | `docs/04-design/DesignSystem.md §2.6`  |
| Data display           | `<Table variant="bordered">`                                  | bordered     | `docs/04-design/DesignSystem.md §2.7`  |
| Tab navigation         | `<Tabs variant="underline">`                                  | underline    | `docs/04-design/DesignSystem.md §2.8`  |
| Loading state          | `<Skeleton variant="text" \| "card">`                         | per shape    | `docs/04-design/DesignSystem.md §2.10` |
| Avatar                 | `<Avatar size="md">`                                          | md           | `docs/04-design/DesignSystem.md §2.9`  |
...
| DoD-014 | ADR created if architectural decision was made     | `docs/27-decisions/` directory |
...
| `docs/04-design/DesignTokens.md` (v5.0)               | Visual identity — color philosophy, typography system              |
| `docs/04-design/DesignSystem.md` (v5.0)               | Component library — 10 cataloged components, 120+ design tokens    |
| `docs/05-architecture/SystemArchitecture.md` (v5.0)   | System architecture — 3-tier microservices, 14 ADRs                |
| `docs/05-architecture/10-TECHSTACK.md` (v5.0)         | Technology decisions — rationale for every tech choice             |
| `docs/09-database/DatabaseArchitecture.md` (v5.0)     | Database schema — 37 tables, RLS policies, indexing strategy       |
| `docs/10-api/12-API.md` (v5.0)                        | API documentation — 74 endpoints, 17 API groups                    |
| `docs/11-security/SecurityArchitecture.md` (v5.0)     | Security implementation — OWASP Top 10:2025, 5-layer defense       |
| `docs/08-ai/17-AI_INSTRUCTIONS.md` (v5.0)             | AI operating model — 25 sections, safety rules, cost control       |
| `docs/35-quality/PerformanceArchitecture.md` (v5.0)   | Performance standards — budgets, optimization techniques           |
| `docs/35-quality/AccessibilityArchitecture.md` (v5.0) | Accessibility — WCAG 2.2 AA+, 24 sections, 35-component matrix     |
| `docs/35-quality/TestingArchitecture.md` (v5.0)       | Testing architecture — 23 sections, pyramid, coverage requirements |
| `docs/35-quality/30-QA.md` (v5.0)                     | QA framework — 24 sections, release gates, bug severity matrix     |
