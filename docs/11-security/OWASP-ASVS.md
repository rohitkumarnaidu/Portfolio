...
- `docs/11-security/SecurityArchitecture.md` Ã¢â‚¬â€ Security architecture (5-layer defense, 20 controls)
- `docs/11-security/ThreatModel.md` Ã¢â‚¬â€ STRIDE threat model
- `docs/11-security/SecretsManagement.md` Ã¢â‚¬â€ Secrets management policy
- `docs/11-security/data-classification.md` Ã¢â‚¬â€ Data classification (L1-L4 tiers)
- `docs/11-security/43-DATA-GOVERNANCE.md` Ã¢â‚¬â€ Data governance framework
- `docs/11-security/15-AUTHORIZATION.md` Ã¢â‚¬â€ Authorization architecture (RBAC + RLS)
- `docs/11-security/AuditLogging.md` Ã¢â‚¬â€ Audit logging policy
- `docs/11-security/16-COMPLIANCE.md` Ã¢â‚¬â€ Compliance documentation
