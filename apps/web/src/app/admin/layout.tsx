...
const AdminScene3D = dynamic(() => import('@/components/3d/Scene3D').then((mod) => mod.Scene3D), {
  ssr: false,
});
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M3 4.5h14.25M3 9h9.75M3 13.5h5.25m5.25-.75H17.25m-9 3h9m-9 3h4.5m4.5-15a3 3 0 00-3-3H5.625a3 3 0 00-3 3v16.5c0 1.104.894 2 2 2h12.75a3 3 0 003-3V6z"
        />
      </svg>
    ),
  },
    ...
    <>
      <div className="flex items-center justify-between h-16 px-4 border-b border-border-primary">
        ...
        <button
          ...
          className="w-8 h-8 rounded-lg flex items-center justify-center text-text-secondary hover:text-text-primary md:hidden"
        >
          <svg
            className="w-5 h-5"
            fill="none"
...
function Breadcrumbs() {
  ...
  return (
    <nav
      className="flex items-center gap-1.5 text-xs text-text-tertiary mb-4 md:mb-6"
      aria-label="Breadcrumb"
    >
      <a href="/admin" className="hover:text-accent-500 transition-colors hover:no-underline">
        Dashboard
      </a>
        ...
        return (
          <span key={segment} className="flex items-center gap-1.5">
            ...
            {isLast ? (
              ...
              <a href={href} className="hover:text-accent-500 transition-colors hover:no-underline">
                {label}
              </a>
            )}
          </span>
...
function KeyboardShortcuts() {
  ...
  const shortcuts = [
    ...
    { key: 'g v', desc: 'Go to Visitors' },
    { key: 'g p', desc: 'Go to Performance' },
    { key: 'g o', desc: 'Go to Content' },
    { key: 'g a', desc: 'Go to Analytics' },
    { key: 'g j', desc: 'Go to Projects' },
    { key: 'g b', desc: 'Go to Blog' },
    { key: 'g s', desc: 'Go to Skills' },
    { key: 'g l', desc: 'Go to Leads' },
    { key: 'g c', desc: 'Go to Case Studies' },
    { key: 'g e', desc: 'Go to Achievements' },
    ...
    { key: 'g y', desc: 'Go to Availability' },
        ...
        <div className="space-y-2">
          {shortcuts.map((s) => (
            <div key={s.key} className="flex items-center justify-between py-1.5">
              ...
              <kbd className="px-2 py-0.5 rounded bg-surface-elevated border border-border-primary text-xs font-mono text-text-primary">
                {s.key}
              </kbd>
            </div>
          ))}
  ...
  return (
    <AdminHealthContext.Provider value={{ health, setHealth: handleSetHealth }}>
      <div className="min-h-dvh bg-surface-primary relative">
        ...
        <main
          className={cn(
            'transition-all duration-300 min-h-dvh relative z-10',
