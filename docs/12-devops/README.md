...
> **Category:** 12-devops | **Docs:** 16 | **Status:** Active

## Overview

DevOps and infrastructure documentation covering CI/CD pipelines, deployment strategies, container strategy, environment management, and cost planning.
...
| [CI-CD-PIPELINE-STRATEGY.md](CI-CD-PIPELINE-STRATEGY.md) |  |
| [CONTAINER-STRATEGY.md](CONTAINER-STRATEGY.md) |  |
...
| [DORA-METRICS.md](DORA-METRICS.md) |  |
...
- [22-release/](../22-release/README.md) — Release
