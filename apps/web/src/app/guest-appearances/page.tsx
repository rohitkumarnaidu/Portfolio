      ...
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24">
        <div className="mb-12">
          ...
          <p className="text-body text-text-secondary max-w-2xl">
            Podcasts, talks, interviews, and webinars I&apos;ve been featured on.
          </p>
        </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-xs font-medium px-2 py-0.5 rounded bg-surface-elevated text-text-tertiary capitalize">
                            {a.type}
                          </span>
                        ...
                        {a.description && (
                          <p className="text-sm text-text-tertiary mt-2">{a.description}</p>
                        )}
                        <div className="flex items-center gap-3 mt-3">
                          ...
                          {a.duration && (
                            <span className="text-xs text-text-tertiary">{a.duration}</span>
                          )}
                        </div>
                      </div>
                    </div>
