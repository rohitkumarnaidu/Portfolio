...
- `docs/08-ai/model-cards/GPT4O.md`
- `docs/08-ai/model-cards/CLAUDE-SONNET.md`
- `docs/08-ai/model-cards/TEXT-EMBEDDING-3.md`
...
\* _This is the direct API cost per request. The estimated $3.00 total accounts for periodic higher-usage months, embedding batch operations, and ingestion jobs._
