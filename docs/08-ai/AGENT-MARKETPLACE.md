...
```json
{
  ...
  "syncResponse": {
    ...
    "newAgents": [{ "id": "...", "name": "com.enterprise.new-agent", "version": "1.0.0" }],
    "updatedAgents": [
      {
        "name": "com.enterprise.security-threat-analyzer",
        "fromVersion": "2.0.0",
...
| ----------------------- | -------------------------------------------------- | ------------------------------------ |
| AGENTS.md               | Agent lifecycle management, states, transitions    | `docs/08-ai/18-AGENTS.md`            |
| AGENT-REGISTRY.md       | Agent Registry service architecture and API        | `docs/08-ai/AGENT-REGISTRY.md`       |
| AGENT-CAPABILITIES.md   | Agent capability model, discovery, and negotiation | `docs/08-ai/AGENT-CAPABILITIES.md`   |
| AGENT-SECURITY.md       | Agent security model, sandboxing, auditing         | `docs/11-security/AGENT-SECURITY.md` |
| AGENT-NETWORKING.md     | Agent-to-agent and agent-to-service communication  | `docs/08-ai/AGENT-NETWORKING.md`     |
| MARKETPLACE-API-SPEC.md | Full OpenAPI specification                         | `docs/08-ai/MARKETPLACE-API-SPEC.md` |
| DEPLOYMENT-GUIDE.md     | Marketplace deployment and operations guide        | `docs/10-api/DEPLOYMENT-GUIDE.md`    |
| PACKAGE-DEVELOPMENT.md  | Guide for developing and publishing agent packages | `docs/08-ai/PACKAGE-DEVELOPMENT.md`  |
...
| RAG                  | Retrieval-Augmented Generation ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â enhances LLM responses with retrieved documents |
...
| LLM                  | Large Language Model ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the AI model powering agent reasoning                     |
