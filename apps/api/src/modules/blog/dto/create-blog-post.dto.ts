import { IsString, IsBoolean, IsNumber, IsOptional, IsArray, IsUrl, Min, MaxLength, MinLength, ArrayMinSize } from 'class-validator';
...
export class CreateBlogPostDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsArray() @IsString({ each: true }) @ArrayMinSize(1) tags?: string[];
...
export class UpdateBlogPostDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsBoolean() isPublished?: boolean;
  @ApiPropertyOptional() @IsOptional() @IsBoolean() isFeatured?: boolean;
  @ApiPropertyOptional() @IsOptional() @IsString() @MinLength(2) @MaxLength(100) authorName?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() seoTitle?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() seoDescription?: string;
}
