...
> _"A new day. Everything feels fresh, optimistic, and full of possibility."_
...
> _"Peak energy. Full clarity. The world is bright, vivid, and buzzing with creative power."_
...
> _"The golden hour. Everything slows down. Warm, pleasant, and deeply satisfying."_
...
> _"Deep night. The world is quiet. Focus is sharp. Creativity flows without distraction."_
...
```html
<html data-theme="dawn" data-mode="light"></html>
```

CSS selectors:

```css
[data-theme='dawn'][data-mode='light'] {
  /* Dawn Light tokens */
}
[data-theme='dawn'][data-mode='dark'] {
  /* Dawn Dark tokens */
}
[data-theme='zenith'][data-mode='light'] {
  /* Zenith Light tokens */
}
/* ... etc */
```
...
_Document Version: 1.0 — Circadian Theme Engine_
